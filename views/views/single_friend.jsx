...
class Single_Friend extends React.Component {
  render() {
    ...
    let submitUrl = "/BillSplitter/friendList/"+this.props.friend_id+"/settleByUser"
    return (
      <Default title={this.props.title} cookieAvailable={this.props.cookieAvailable} user_name={this.props.user_name}>
          <div className="card-slot">
                <div className="single-friend-container">
                    ...
                    <a href="/BillSplitter/friendList"className="back-to-main-page-button"><img src="https://www.pinclipart.com/picdir/middle/214-2147603_free-returns-return-icon-vector-clipart.png"/></a>
