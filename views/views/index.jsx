    ...
    return (
      <Default title={this.props.title} cookieAvailable={this.props.cookieAvailable} user_name={this.props.user_name} user_name={this.props.user_name}>
        ...
        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
            <li class="nav-item ">
                <a class="nav-link active" id="home-tab"  href="/BillSplitter" role="tab" >Personal</a>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item">
                <a class="nav-link" id="activity-tab"  href="/BillSplitter/activityList" role="tab" >Activity</a>
              </li>
        </ul>
            <div class="tab-content tab-modifier" id="myTabContent">
                ...
                <div class="card border-info mb-3 profile-card-modifier" style={{width: "230px"}}>
                    ...
                    <p class="card-text" style={{color:"#5D3BC4"}}>₹ {this.props.totalLent.toFixed(2)}</p>
                    </div>
                </div>
                </div>
