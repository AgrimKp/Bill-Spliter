...
class Create_Bill extends React.Component {
  render() {
    ...
    let url = "/BillSplitter/groupList/"+this.props.group_id+"/"+this.props.bill_id+"/editBill"
    let cancelUrl = "/BillSplitter/groupList/"+this.props.group_id+"/"+this.props.bill_id;
