...
class Login extends React.Component {
  render() {
    ...
    let url = this.props.cookieAvailable? "/BillSplitter/logout":"/BillSplitter/login";
        ...
        <body>
            ...
            <div className="login-page-container">
                  ...
                  <div id="carouselExampleCaptions" class="carousel slide carousel-slide-modifier" data-ride="carousel">
                    ...
                    <div class="carousel-inner carousel-inner-modifier">
                      <div class="carousel-item active carousel-item-modifier item-1">
                        ...
                        <h2 className="image-1-welcome"><span id="blitt-name">Bill Splitter</span></h2>
                        <p>A Bill Splitting App To Remind Your Friends They Owe You</p>
                      </div>
                ...
                <div className="login-container login-container-modifier">
                    ...
                    {loginAlert}
                    {register}
                    <form method="POST" action="/BillSplitter/login">
                      ...
                      <a className="btn btn-outline-success"href="/BillSplitter/register">Register</a>
                    </form>
