  ...
  Edit profile successful.
    ...
    return (
      <Default title={this.props.title} cookieAvailable={this.props.cookieAvailable} user_name={this.props.user_name}>
            ...
            <form enctype="multipart/form-data" action="/BillSplitter/user_profile/postProfilePic" method="POST" className="profile-pic-form">
                ...
                <div className="user-page-edit-container">
                    <a className="btn btn-danger" href="/BillSplitter/user_profile/edit_profile">Edit Profile</a>
                    <a className="btn btn-danger delete-button" href="/BillSplitter/user_profile/change_password">Change Password</a>
                </div>
            </form>
