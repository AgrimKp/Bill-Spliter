...
class BillHead extends React.Component {
  render() {
    ...
    let backUrl = "/BillSplitter/groupList/"+this.props.group_id
    ...
    let editUrl = "/BillSplitter/groupList/"+group_id+"/"+bill_id+"/editBill"
    let delteUrl = "/BillSplitter/groupList/"+group_id+"/"+bill_id+"/deleteBill"
