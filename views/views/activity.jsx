...
class Activity extends React.Component {
  render() {
    let activity_list = this.props.result.map(x=>{
        if(x.category === "added"){
            let persona = "";
            let url = "/BillSplitter/groupList/"+x.group_id+"/"+x.bill_id;
            let groupUrl = "/BillSplitter/groupList"+x.group_id;
            ...
            let persona = "";
            let url = "/BillSplitter/groupList/"+x.group_id
            if(parseInt(this.props.user_id) === parseInt(x.user_id)){
                persona = "You"
            }else{
                persona = x.user_name
            ...
            let persona = "";
            let url = "/BillSplitter/groupList/"+x.group_id
            let billUrl = "/BillSplitter/groupList/"+x.group_id+"/"+x.bill_id
            if(parseInt(this.props.user_id) === parseInt(x.user_id)){
                persona = "You"
            }else{
                persona = x.user_name
            ...
            let persona = "";
            let url = "/BillSplitter/groupList/"+this.props.group_id
            if(parseInt(this.props.user_id) === parseInt(x.user_id)){
                persona = "You"
            }else{
                persona = x.user_name
    ...
    return (
      <Default title={this.props.title} cookieAvailable={this.props.cookieAvailable} user_name={this.props.user_name}>
            <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
              <li class="nav-item ">
                <a class="nav-link" id="home-tab"  href="/BillSplitter" role="tab" >Personal</a>
              </li>
              <li class="nav-item ">
                <a class="nav-link" id="profile-tab"  href="/BillSplitter/groupList" role="tab" >Group</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="contact-tab"  href="/BillSplitter/friendList" role="tab" >Friends</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" id="activity-tab"  href="/BillSplitter/activityList" role="tab" >Activity</a>
              </li>
            </ul>
